...
import { idlFactory } from './MarketEarthEngine.did.js';
export { idlFactory } from './MarketEarthEngine.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.MARKETEARTHENGINE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./MarketEarthEngine.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the MarketEarthEngine canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./MarketEarthEngine.did.js")._SERVICE>}
 */
export const MarketEarthEngine = createActor(canisterId);
